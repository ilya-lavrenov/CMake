...
unset(CPACK_DEBIAN_PACKAGE_LINTIAN_OVERRIDES)
...
# Generation of lintian overrides files
if(CPACK_DEB_PACKAGE_COMPONENT AND CPACK_DEBIAN_COMPONENT_${COMPONENT_UPCASE}_LINTIAN_OVERRIDES)
  set(suppressions ${CPACK_DEBIAN_COMPONENT_${COMPONENT_UPCASE}_LINTIAN_OVERRIDES})
  set(package_name ${CPACK_DEBIAN_COMPONENT_${COMPONENT_UPCASE}_NAME})
  foreach(suppression ${suppressions})
    set(line "${package_name}: ${suppression}")
    if(CPACK_DEBIAN_PACKAGE_LINTIAN_OVERRIDES)
      set(CPACK_DEBIAN_PACKAGE_LINTIAN_OVERRIDES "${CPACK_DEBIAN_PACKAGE_LINTIAN_OVERRIDES}\n${line}")
    else()
      set(CPACK_DEBIAN_PACKAGE_LINTIAN_OVERRIDES "${line}")
    endif()
  endforeach()
endif()
