...
if (CPACK_DEBIAN_PACKAGE_SHLIBS_LIST)
  ...
  if (NOT CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA MATCHES "postinst")
    file(WRITE "${CPACK_TEMPORARY_DIRECTORY}/postinst" "#!/bin/sh\nset -e\nif [ \"$1\" = \"configure\" ]; then\n\tldconfig\nfi")
    list(APPEND CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA "${CPACK_TEMPORARY_DIRECTORY}/postinst")
  endif()
  if (NOT CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA MATCHES "postrm")
    file(WRITE "${CPACK_TEMPORARY_DIRECTORY}/postrm" "#!/bin/sh\nset -e\nif [ \"$1\" = \"configure\" ]; then\n\tldconfig\nfi")
    list(APPEND CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA "${CPACK_TEMPORARY_DIRECTORY}/postrm")
  endif()
endif()
