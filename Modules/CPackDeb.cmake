...
unset(CPACK_DEBIAN_PACKAGE_SHLIBS_TMP)
...
set(_DESCRIPTION ${CPACK_COMPONENT_${CPACK_DEB_PACKAGE_COMPONENT}_DESCRIPTION})
if (_DESCRIPTION)
...
foreach(_FILE ${CPACK_DEB_SHARED_OBJECT_FILES})
  ...
  list(APPEND CPACK_DEBIAN_PACKAGE_SHLIBS_TMP "${_LIBNAME} ${CMAKE_MATCH_1} ${CPACK_DEBIAN_PACKAGE_NAME}")
endforeach()
if (CPACK_DEBIAN_PACKAGE_SHLIBS_TMP)
  string(REPLACE ";" "\n" CPACK_DEBIAN_PACKAGE_SHLIBS "${CPACK_DEBIAN_PACKAGE_SHLIBS_TMP}")
endif()
