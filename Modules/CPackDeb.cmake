...
if(CPACK_DEB_PACKAGE_COMPONENT)
  ...
  set(_DEPS "${CPACK_COMPONENT_${CPACK_DEB_PACKAGE_COMPONENT}_DEPENDS}")
  foreach (_PACK ${_DEPS})
    if (CPACK_COMPONENT_${_PACK}_DISPLAY_NAME)
      string(TOLOWER ${CPACK_COMPONENT_${_PACK}_DISPLAY_NAME} _PACK_NAME)
    else()
      set(_PART_NAME "-${_PACK}")
      string(TOLOWER "${CPACK_PACKAGE_NAME}${_PART_NAME}" _PACK_NAME)
    endif()
...
set(_DEB_DEPENDS ${CPACK_DEB_${CPACK_DEB_PACKAGE_COMPONENT}_PACKAGE_DEPENDS})
if(_DEB_DEPENDS)
  if (CPACK_DEBIAN_PACKAGE_AUTO_DEPENDS)
...
if(CPACK_DEB_PACKAGE_COMPONENT)
  if (CPACK_COMPONENT_${CPACK_DEB_PACKAGE_COMPONENT}_DESCRIPTION_SUMMARY)
    set(CPACK_DEBIAN_PACKAGE_DESCRIPTION_SUMMARY ${CPACK_COMPONENT_${CPACK_DEB_PACKAGE_COMPONENT}_DESCRIPTION_SUMMARY})
  else()
    set(CPACK_DEBIAN_PACKAGE_DESCRIPTION_SUMMARY ${CPACK_PACKAGE_DESCRIPTION_SUMMARY})
  endif()
  if (CPACK_COMPONENT_${CPACK_DEB_PACKAGE_COMPONENT}_DESCRIPTION)
    set(CPACK_DEBIAN_PACKAGE_DESCRIPTION ${CPACK_COMPONENT_${CPACK_DEB_PACKAGE_COMPONENT}_DESCRIPTION})
  else()
...
if(NOT CPACK_DEBIAN_PACKAGE_DESCRIPTION_SUMMARY)
  message(FATAL_ERROR "CPackDeb: Debian package requires a summary description for a package, set CPACK_PACKAGE_DESCRIPTION_SUMMARY")
endif()

if (CPACK_DEBIAN_PACKAGE_DESCRIPTION)
  set(CPACK_DEBIAN_PACKAGE_DESCRIPTION "${CPACK_DEBIAN_PACKAGE_DESCRIPTION_SUMMARY}\n ${CPACK_DEBIAN_PACKAGE_DESCRIPTION}")
endif()
...
if(CPACK_DEB_PACKAGE_COMPONENT)
  if (CPACK_COMPONENT_${CPACK_DEB_PACKAGE_COMPONENT}_SECTION)
    set(CPACK_DEBIAN_PACKAGE_SECTION_FINAL ${CPACK_COMPONENT_${CPACK_DEB_PACKAGE_COMPONENT}_SECTION})
  else()
...
set(CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA_FINAL ${CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA})

# Are we packaging components ?
if(CPACK_DEB_PACKAGE_COMPONENT)
  if (CPACK_COMPONENT_${CPACK_DEB_PACKAGE_COMPONENT}_DISPLAY_NAME)
    string(TOLOWER ${CPACK_COMPONENT_${CPACK_DEB_PACKAGE_COMPONENT}_DISPLAY_NAME} CPACK_DEBIAN_PACKAGE_NAME)
  else()
...
if (CPACK_DEBIAN_PACKAGE_SHLIBS_LIST)
  ...
  # add postinst and postrm scripts if they are not present in CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA
  if (NOT CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA_FINAL MATCHES "postinst")
    file(WRITE "${CPACK_TEMPORARY_DIRECTORY}/postinst" "#!/bin/sh\nset -e\nif [ \"$1\" = \"configure\" ]; then\n\tldconfig\nfi")
    list(APPEND CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA_FINAL "${CPACK_TEMPORARY_DIRECTORY}/postinst")
  endif()
  if (NOT CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA_FINAL MATCHES "postrm")
    file(WRITE "${CPACK_TEMPORARY_DIRECTORY}/postrm" "#!/bin/sh\nset -e\nif [ \"$1\" = \"configure\" ]; then\n\tldconfig\nfi")
    list(APPEND CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA_FINAL "${CPACK_TEMPORARY_DIRECTORY}/postrm")
  endif()
endif()
